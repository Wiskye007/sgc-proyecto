      ...
      <div className="container mx-auto max-w-4xl relative z-10 space-y-6">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 bg-card/80 p-6 rounded-2xl border border-border/80 backdrop-blur-xl shadow-2xl">
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-3xl font-black text-foreground tracking-wide">Mi Perfil</h1>
                    <p className="text-primary text-xs font-bold uppercase tracking-widest mt-1">Administración de cuenta y seguridad</p>
                </div>
            </div>
        </div>
        
        <Tabs defaultValue="info" className="w-full">
          <TabsList className="mb-6 flex w-full bg-card/60 border border-border/50 p-1.5 rounded-xl h-auto">
            <TabsTrigger value="info" className="flex-1 py-2.5 text-center rounded-lg data-[state=active]:bg-blue-600 data-[state=active]:text-foreground data-[state=active]:shadow-lg text-foreground hover:text-foreground transition-all font-semibold tracking-wide">Información Personal</TabsTrigger>
            <TabsTrigger value="seguridad" className="flex-1 py-2.5 text-center rounded-lg data-[state=active]:bg-blue-600 data-[state=active]:text-foreground data-[state=active]:shadow-lg text-foreground hover:text-foreground transition-all font-semibold tracking-wide">Seguridad</TabsTrigger>
          </TabsList>
          ...
          <TabsContent value="info" className="space-y-6">
            ...
            <Card className="sgc-card border-0 bg-card/60 shadow-xl border-border/80">
              <CardHeader className="border-b border-border/60 pb-4">
                <CardTitle className="text-foreground text-lg flex items-center gap-2">
                  <User className="w-5 h-5 text-primary" /> Datos registrados
                </CardTitle>
                <CardDescription className="text-foreground">Información interna inmutable</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4 pt-0">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-foreground uppercase tracking-widest text-[10px] font-bold mb-2">Usuario</label>
                    <div className="bg-card px-4 py-3 rounded-lg border border-border text-foreground font-mono text-sm">
                      {perfil.nombreUsuario}
                    </div>
                  </div>
                  <div>
                    <label className="block text-foreground uppercase tracking-widest text-[10px] font-bold mb-2">DNI</label>
                    <div className="bg-card px-4 py-3 rounded-lg border border-border text-foreground font-mono text-sm">
                      {perfil.dni || 'No registrado'}
                    </div>
                  </div>
                  <div>
                    <label className="block text-foreground uppercase tracking-widest text-[10px] font-bold mb-2">Nivel de Acceso</label>
                    <div className="bg-blue-500/10 px-4 py-3 rounded-lg border border-blue-500/20 text-primary font-bold text-sm uppercase tracking-wide">
                      {perfil.nivelAcceso}
                    </div>
                  </div>
                  <div>
                    <label className="block text-foreground uppercase tracking-widest text-[10px] font-bold mb-2">Estado</label>
            ...
            <Card className="sgc-card border-0 bg-card/60 shadow-xl border-border/80">
              <CardHeader className="border-b border-border/60 pb-4">
                <CardTitle className="text-foreground text-lg flex items-center gap-2">
                  <Briefcase className="w-5 h-5 text-primary" /> Información editable
                </CardTitle>
                <CardDescription className="text-foreground">{editando ? 'Modifique los campos y guarde los cambios' : 'Datos que puedes actualizar'}</CardDescription>
              </CardHeader>
              <CardContent className="space-y-5 pt-0">
                <div>
                  ...
                  <Input
                    ...
                    className="sgc-input h-11 bg-card border-border focus:border-blue-500"
                  />
                </div>

                <div>
                  <label className="block text-foreground text-sm font-medium mb-2">
                    <Mail className="w-4 h-4 inline mr-2 text-foreground" /> Correo electrónico
                  </label>
                  <Input
                    disabled={!editando}
                    name="correo"
                ...
                <div>
                  <label className="block text-foreground text-sm font-medium mb-2">Cargo institucional</label>
                  <Input
                    disabled={!editando}
                    name="cargo"
            ...
            {/* Auditoría */}
            <div className="flex justify-between items-center text-xs text-foreground px-4 font-mono">
          ...
          <TabsContent value="seguridad" className="space-y-6">
            <Card className="sgc-card border-0 bg-card/60 shadow-xl border-border/80">
              <CardHeader className="border-b border-border/60 pb-4">
                ...
                <CardDescription className="text-foreground">Su contraseña debe tener mínimo 6 caracteres</CardDescription>
              </CardHeader>
              <CardContent className="space-y-5 pt-0">
                <div>
                  <label className="block text-foreground text-sm font-medium mb-2">Contraseña actual *</label>
                  <div className="relative">
                    <Input
                      ...
                      className="sgc-input h-11 bg-card border-border pr-10 focus:border-blue-500"
                    />
                    <button type="button" onClick={() => setShowPasswordFields(prev => ({ ...prev, actual: !prev.actual }))} className="absolute right-3 top-1/2 -translate-y-1/2 text-foreground hover:text-foreground">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                    <label className="block text-foreground text-sm font-medium mb-2">Nueva contraseña *</label>
                    <div className="relative">
                        <Input
                        ...
                        className="sgc-input h-11 bg-card border-border pr-10 focus:border-blue-500"
                        />
                        <button type="button" onClick={() => setShowPasswordFields(prev => ({ ...prev, nueva: !prev.nueva }))} className="absolute right-3 top-1/2 -translate-y-1/2 text-foreground hover:text-foreground">
                    ...
                    <div>
                    <label className="block text-foreground text-sm font-medium mb-2">Confirmar contraseña *</label>
                    <div className="relative">
                        <Input
                        ...
                        className="sgc-input h-11 bg-card border-border pr-10 focus:border-blue-500"
                        />
                        <button type="button" onClick={() => setShowPasswordFields(prev => ({ ...prev, confirmacion: !prev.confirmacion }))} className="absolute right-3 top-1/2 -translate-y-1/2 text-foreground hover:text-foreground">
